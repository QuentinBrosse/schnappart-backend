"""
Django settings for schnappart project.
...
SECRET_KEY = '*(5e0ed+jgzx2370npslvjs59b-7^i2g!j+u4f=7=zm8_wdp=z'
...
WSGI_APPLICATION = 'schnappart.wsgi.application'
